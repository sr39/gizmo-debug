...
/* this version of the HII routine only communicates with particles on the same processor */
...
void HII_heating_singledomain(void)
{
    ...
    double dx, dy, dz, h_i2, r2, r, u, u_to_temp_fac,mionizable,mionized,RHII,RHIIMAX,R_search,rnearest;
    double stellum,uion,prob,rho_j,prandom,m_available,m_effective,RHII_initial,RHIImultiplier;
