...
#define OUTPUT_ONLY_ON_N_HIGHEST_TIMEBIN 10 //only prints outputs to log file if the highest active timebin index is within n of the highest timebin (dt_bin=2^(-N)*dt_bin,max)
#ifdef MAGNETIC
