...
#define PRINT_STATUS(...) {if(All.HighestActiveTimeBin == All.HighestOccupiedTimeBin) {if(ThisTask==0) {printf( __VA_ARGS__ ); fflush(stdout);}}}
#else
#define PRINT_STATUS(...) {if(ThisTask==0) {printf( __VA_ARGS__ ); fflush(stdout);}}
#endif
