...
#BH_REPOSITION_ON_POTMIN_STAR     # DAA: repositions hole on potential minimum of stars
#BH_INCREASE_DYNAMIC_MASS=1000    # DAA: Increase the dynamic (real) particle mass by this factor
