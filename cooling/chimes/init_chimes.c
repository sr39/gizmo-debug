...
void GetEqAbundancesTables(struct globalVariables *myGlobalVars)
{
  ...
  EquilibriumAbundances.Temperatures = (double *) malloc(EquilibriumAbundances.N_Temperatures * sizeof(double));
  EquilibriumAbundances.Densities = (double *) malloc(EquilibriumAbundances.N_Densities * sizeof(double));
  EquilibriumAbundances.Metallicities = (double *) malloc(EquilibriumAbundances.N_Metallicities * sizeof(double));
  T = (double *) malloc(EquilibriumAbundances.N_Temperatures * sizeof(double));
  nH = (double *) malloc(EquilibriumAbundances.N_Densities * sizeof(double));
  Z = (double *) malloc(EquilibriumAbundances.N_Metallicities * sizeof(double));
  array1D = (double *) malloc(EquilibriumAbundances.N_Temperatures * sizeof(double));

  EquilibriumAbundances.EqAbundances = (double ****) malloc(EquilibriumAbundances.N_Temperatures * sizeof(double ***));
  for (i = 0; i < EquilibriumAbundances.N_Temperatures; i++)
    {
      EquilibriumAbundances.EqAbundances[i] = (double ***) malloc(EquilibriumAbundances.N_Densities * sizeof(double **));
      for (j = 0; j < EquilibriumAbundances.N_Densities; j++)
	{
	  EquilibriumAbundances.EqAbundances[i][j] = (double **) malloc(EquilibriumAbundances.N_Metallicities * sizeof(double *));
	  for (k = 0; k < EquilibriumAbundances.N_Metallicities; k++)
	    EquilibriumAbundances.EqAbundances[i][j][k] = (double *) malloc(myGlobalVars->totalNumberOfSpecies * sizeof(double));
	}
    }
  /* Read in tables. */
  ...
  for (i = 0; i < EquilibriumAbundances.N_Densities; i++)
      ...
      for (j = 0; j < EquilibriumAbundances.N_Metallicities; j++)
	{
	  for (k = 0; k < myGlobalVars->totalNumberOfSpecies; k++)
		...
		EquilibriumAbundances.EqAbundances[l][i][j][k] = log10(max(array1D[l], 1.0e-95));  /* If the table accidentally contains negative values, we need to force it to be positive before taking the log. */
	    }
	}
    }
...
void GetPhotoIonTables(struct globalVariables *myGlobalVars, int N_Elements_in_Bens_tables, struct All_rate_variables_structure **this_all_rates, double *dustG_arr, double *H2_dissocJ_arr)
{
  ...
  if ((fdin = fopen(myGlobalVars->PhotoIonTablePath, "r"))) 
      ...
      while (fgets(buffer, 500, fdin)) 
	{
	  ...
	  ReadPhotoIonTables(myGlobalVars, table_path, chimesRateTables.NonEqIon, N_Elements_in_Bens_tables, dustG_arr, H2_dissocJ_arr, current_spectrum);
	  current_spectrum += 1;
	}
...
void ReadPhotoIonTables(struct globalVariables *myGlobalVars, char *photoIonTablePath, struct NonEq_Ionization *myNonEqIon, int N_Elements_in_Bens_tables, double *dustG_arr, double *H2_dissocJ_arr, int current_spectrum)
{
  hid_t file_id, dataset, dataspace_id, memspace_id;
  herr_t status;
  hsize_t dims[2];
...
void initialise_bens_tables(struct globalVariables *myGlobalVars, struct All_rate_variables_structure **this_all_rates, double *dustG_arr, double *H2_dissocJ_arr)
{
...
{  
  ...
  chimesRateTables.RatesTables = (struct Additional_Rates *) malloc(sizeof(struct Additional_Rates));
  ...
  chimesRateTables.RatesTables->Temperatures = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction1 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction2 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction3 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction5 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction6 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction7 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction10 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction11 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction13A = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction13B = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction15 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction16 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction17 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction24 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction25rrA = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction25rrB = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction25di = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction26 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction27 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction83 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction84 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction87 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction97 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction101 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction106 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction107 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction112 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction113 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction114 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction116 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction117 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction120 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction121 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction122 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction124 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction128 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction129 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction130 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction131 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction133 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction134 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction135 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction136 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction137 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction138 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction139 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction142 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction147 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction150 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction157 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction186 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction187 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction188 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction189 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction190 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction191 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction192 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction193 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction194 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction195 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction196 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction197 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction198 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction199 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction200 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction201 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction202 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction203 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction204 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction205 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction206 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction207 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction220 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction221 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction222 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction223 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction225 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction226 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction227 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction228 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction229 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction230 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction231 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction232 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction233 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction234 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction235 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction236 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction237 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction238 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
  chimesRateTables.RatesTables->reaction283 = (double *) malloc(chimesRateTables.RatesTables->N_Temperatures * sizeof(double));
...
{
  chimesRateTables.mol_cooling_table_CO_rot_T = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[0] * sizeof(double));
  chimesRateTables.mol_cooling_table_CO_rot_N = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[1] * sizeof(double));
  chimesRateTables.mol_cooling_table_CO_vib_T = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[2] * sizeof(double));
  chimesRateTables.mol_cooling_table_CO_vib_N = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[3] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_T = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[4] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_N = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[5] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_rot_lowT_T = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_rot_lowT_N = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_vib_T = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[8] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_vib_N = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[9] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2_lte_temperatures = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[10] * sizeof(double));
}
...
void ReadMolecularCoolingHeader(struct globalVariables *myGlobalVars)
{
  ...
  status = H5Dread(dataset_id, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, chimesRateTables.mol_cooling_table_H2_lte_temperatures);
  status = H5Dclose(dataset_id);
...
void initialise_cooling(struct globalVariables *myGlobalVars)
{
  ...
  chimesRateTables.mol_cooling_table_CO_rot_L0 = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[0] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_L0 = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[4] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_L0 = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double));
  chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_L0 = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double));	
  chimesRateTables.mol_cooling_table_H2_lte = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[10] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_CO_rot_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[0] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[0]; i++)
    chimesRateTables.mol_cooling_table_CO_rot_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[1] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_CO_rot_nhalf = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[0] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[0]; i++)
    chimesRateTables.mol_cooling_table_CO_rot_nhalf[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[1] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_CO_rot_a = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[0] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[0]; i++)
    chimesRateTables.mol_cooling_table_CO_rot_a[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[1] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_CO_vib_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[2] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[2]; i++)
    chimesRateTables.mol_cooling_table_CO_vib_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[3] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[4] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[4]; i++)
    chimesRateTables.mol_cooling_table_H2O_rot_hiT_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[5] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_nhalf = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[4] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[4]; i++)
    chimesRateTables.mol_cooling_table_H2O_rot_hiT_nhalf[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[5] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2O_rot_hiT_a = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[4] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[4]; i++)
    chimesRateTables.mol_cooling_table_H2O_rot_hiT_a[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[5] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_nhalf = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_nhalf[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_a = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Oortho_rot_lowT_a[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_nhalf = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_nhalf[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_a = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[6] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[6]; i++)
    chimesRateTables.mol_cooling_table_H2Opara_rot_lowT_a[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[7] * sizeof(double));
  
  chimesRateTables.mol_cooling_table_H2O_vib_Llte = (double **) malloc(chimesRateTables.mol_cooling_table_dimensions[8] * sizeof(double *));
  for (i = 0; i < chimesRateTables.mol_cooling_table_dimensions[8]; i++)
    chimesRateTables.mol_cooling_table_H2O_vib_Llte[i] = (double *) malloc(chimesRateTables.mol_cooling_table_dimensions[9] * sizeof(double));
	
  /* Read in the molecular cooling table */
  GetMolecularCoolingTable(myGlobalVars);
}
struct Reactions_Structure * add_new_reaction(struct Reactions_Structure *prev_reaction, int reactant1, int reactant2, int reactant3, int N_reactants, int product1, int product2, int product3, int N_products, double *rate, int incl_mol, int *speciesIndices)
{
  int i;
  int incl_reaction = 1;
  ...
  if (incl_reaction == 1)
    {
      conductor = malloc(sizeof(struct Reactions_Structure));
      prev_reaction->next_reaction = conductor;
      conductor->no_of_reactants = N_reactants;
      conductor->no_of_products = N_products;
      conductor->reactants = (int *) malloc(sizeof(int) * N_reactants);
      conductor->products = (int *) malloc(sizeof(int) * N_products);
...
void initialise_reactions(struct Reactions_Structure *root_node, int incl_mol, struct globalVariables *myGlobalVars, struct All_rate_variables_structure *this_all_rates)
{
  ...
  last_reaction = add_new_reaction(last_reaction, HI, elec, 0, 2, Hm, 0, 0, 1, &this_all_rates->rate_1, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, HII, 0, 2, HI, HI, 0, 2, &this_all_rates->rate_5, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, elec, 0, 2, HII, elec, elec, 3, &this_all_rates->rate_11, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HII, elec, 0, 2, HI, 0, 0, 1, &this_all_rates->rate_13, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, elec, 0, 2, HI, elec, elec, 3, &this_all_rates->rate_15, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, HI, 0, 2, HI, HI, elec, 3, &this_all_rates->rate_16, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeI, elec, 0, 2, HeII, elec, elec, 3, &this_all_rates->rate_24, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeII, elec, 0, 2, HeI, 0, 0, 1, &this_all_rates->rate_25, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeII, HI, 0, 2, HeI, HII, 0, 2, &this_all_rates->rate_26, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeI, HII, 0, 2, HeII, HI, 0, 2, &this_all_rates->rate_27, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, SiI, 0, 2, CI, SiII, 0, 2, &this_all_rates->rate_44, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HII, elec, 0, 2, HI, 0, 0, 1, &this_all_rates->rate_61, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeII, elec, 0, 2, HeI, 0, 0, 1, &this_all_rates->rate_63, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, elec, 0, 2, CI, 0, 0, 1, &this_all_rates->rate_64, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OII, elec, 0, 2, OI, 0, 0, 1, &this_all_rates->rate_65, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, SiII, elec, 0, 2, SiI, 0, 0, 1, &this_all_rates->rate_66, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, FeII, elec, 0, 2, FeI, 0, 0, 1, &this_all_rates->rate_77, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, FeI, CII, 0, 2, FeII, CI, 0, 2, &this_all_rates->rate_79, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, FeI, SiII, 0, 2, FeII, SiI, 0, 2, &this_all_rates->rate_80, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, HI, 0, 2, H2, elec, 0, 2, &this_all_rates->rate_2, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, HII, 0, 2, H2p, 0, 0, 1, &this_all_rates->rate_3, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, H2p, 0, 2, H2, HII, 0, 2, &this_all_rates->rate_4, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2p, elec, 0, 2, HI, HI, 0, 2, &this_all_rates->rate_6, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HII, 0, 2, H2p, HI, 0, 2, &this_all_rates->rate_7, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, elec, 0, 2, HI, HI, elec, 3, &this_all_rates->rate_8, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HI, 0, 2, HI, HI, HI, 3, &this_all_rates->rate_9, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, H2, 0, 2, H2, HI, HI, 3, &this_all_rates->rate_10, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, HII, 0, 2, H2p, elec, 0, 2, &this_all_rates->rate_17, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2p, Hm, 0, 2, H2, HI, 0, 2, &this_all_rates->rate_87, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HeI, 0, 2, HI, HI, HeI, 3, &this_all_rates->rate_88, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2p, Hm, 0, 2, HI, HI, HI, 3, &this_all_rates->rate_83, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, elec, 0, 2, Hm, HI, 0, 2, &this_all_rates->rate_84, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HeII, 0, 2, HeI, HI, HII, 3, &this_all_rates->rate_85, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HeII, 0, 2, H2p, HeI, 0, 2, &this_all_rates->rate_86, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2p, 0, 0, 1, HI, HII, 0, 2, &this_all_rates->rate_52, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, HI, HI, 0, 2, &this_all_rates->rate_53, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, H2p, elec, 0, 2, &this_all_rates->rate_70, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, HI, 0, 2, H2, 0, 0, 1, &this_all_rates->rate_60, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, HI, HI, 0, 2, &this_all_rates->rate_89, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2p, H2, 0, 2, H3p, HI, 0, 2, &this_all_rates->rate_97, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, H3p, 0, 2, HCOp, H2, 0, 2, &this_all_rates->rate_100, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeII, CO, 0, 2, CII, OI, HeI, 3, &this_all_rates->rate_101, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3p, elec, 0, 2, H2, HI, 0, 2, &this_all_rates->rate_106, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HCOp, elec, 0, 2, CO, HI, 0, 2, &this_all_rates->rate_107, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3p, FeI, 0, 2, FeII, H2, HI, 3, &this_all_rates->rate_108, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HCOp, 0, 0, 1, CO, HII, 0, 2, &this_all_rates->rate_111, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3p, HI, 0, 2, H2p, H2, 0, 2, &this_all_rates->rate_112, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, HeII, 0, 2, CI, OII, HeI, 3, &this_all_rates->rate_113, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3p, elec, 0, 2, HI, HI, HI, 3, &this_all_rates->rate_114, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, HII, 0, 2, H3p, 0, 0, 1, &this_all_rates->rate_115, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, OI, 0, 2, CO, 0, 0, 1, &this_all_rates->rate_116, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HI, 0, 2, OI, HI, HI, 3, &this_all_rates->rate_117, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HOCp, H2, 0, 2, HCOp, H2, 0, 2, &this_all_rates->rate_118, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HOCp, CO, 0, 2, HCOp, CO, 0, 2, &this_all_rates->rate_119, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, H2, 0, 2, CH, HI, 0, 2, &this_all_rates->rate_120, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, HI, 0, 2, CI, H2, 0, 2, &this_all_rates->rate_121, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, H2, 0, 2, CH2, HI, 0, 2, &this_all_rates->rate_122, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, CI, 0, 2, C2, HI, 0, 2, &this_all_rates->rate_123, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, OI, 0, 2, CO, HI, 0, 2, &this_all_rates->rate_124, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, HI, 0, 2, CH, H2, 0, 2, &this_all_rates->rate_125, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, OI, 0, 2, CO, HI, HI, 3, &this_all_rates->rate_126, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, OI, 0, 2, CO, H2, 0, 2, &this_all_rates->rate_127, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, C2, OI, 0, 2, CO, CI, 0, 2, &this_all_rates->rate_128, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, H2, 0, 2, OH, HI, 0, 2, &this_all_rates->rate_129, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HI, 0, 2, OI, H2, 0, 2, &this_all_rates->rate_130, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, H2, 0, 2, H2O, HI, 0, 2, &this_all_rates->rate_131, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, CI, 0, 2, CO, HI, 0, 2, &this_all_rates->rate_132, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, OI, 0, 2, O2, HI, 0, 2, &this_all_rates->rate_133, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, OH, 0, 2, H2O, OI, 0, 2, &this_all_rates->rate_134, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, HI, 0, 2, H2, OH, 0, 2, &this_all_rates->rate_135, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, HI, 0, 2, OH, OI, 0, 2, &this_all_rates->rate_136, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, H2, 0, 2, OH, OH, 0, 2, &this_all_rates->rate_137, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, CI, 0, 2, CO, OI, 0, 2, &this_all_rates->rate_138, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, HI, 0, 2, CI, OH, 0, 2, &this_all_rates->rate_139, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, H2p, 0, 2, CHp, HI, 0, 2, &this_all_rates->rate_140, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, H3p, 0, 2, CHp, H2, 0, 2, &this_all_rates->rate_141, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, H2, 0, 2, CHp, HI, 0, 2, &this_all_rates->rate_142, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, HI, 0, 2, CII, H2, 0, 2, &this_all_rates->rate_143, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, H2, 0, 2, CH2p, HI, 0, 2, &this_all_rates->rate_144, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, OI, 0, 2, COp, HI, 0, 2, &this_all_rates->rate_145, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, HII, 0, 2, CHp, H2, 0, 2, &this_all_rates->rate_146, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, HI, 0, 2, CHp, H2, 0, 2, &this_all_rates->rate_147, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, H2, 0, 2, CH3p, HI, 0, 2, &this_all_rates->rate_148, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, OI, 0, 2, HCOp, HI, 0, 2, &this_all_rates->rate_149, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, HI, 0, 2, CH2p, H2, 0, 2, &this_all_rates->rate_150, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, OI, 0, 2, HCOp, H2, 0, 2, &this_all_rates->rate_151, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, C2, OII, 0, 2, COp, CI, 0, 2, &this_all_rates->rate_152, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OII, H2, 0, 2, OHp, HI, 0, 2, &this_all_rates->rate_153, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, H2p, 0, 2, OHp, HI, 0, 2, &this_all_rates->rate_154, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, H3p, 0, 2, OHp, H2, 0, 2, &this_all_rates->rate_155, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, H3p, 0, 2, H2Op, H2, 0, 2, &this_all_rates->rate_156, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, CII, 0, 2, COp, HI, 0, 2, &this_all_rates->rate_157, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OHp, H2, 0, 2, H2Op, HI, 0, 2, &this_all_rates->rate_158, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, H2, 0, 2, H3Op, HI, 0, 2, &this_all_rates->rate_159, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, H3p, 0, 2, H3Op, H2, 0, 2, &this_all_rates->rate_160, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, CII, 0, 2, HCOp, HI, 0, 2, &this_all_rates->rate_161, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, CII, 0, 2, HOCp, HI, 0, 2, &this_all_rates->rate_162, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, CI, 0, 2, HCOp, H2, 0, 2, &this_all_rates->rate_163, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, CII, 0, 2, COp, OI, 0, 2, &this_all_rates->rate_164, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, CII, 0, 2, CO, OII, 0, 2, &this_all_rates->rate_165, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, CH2p, 0, 2, HCOp, OH, 0, 2, &this_all_rates->rate_166, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2p, CI, 0, 2, COp, OI, 0, 2, &this_all_rates->rate_167, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, H3p, 0, 2, HOCp, H2, 0, 2, &this_all_rates->rate_168, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HCOp, CI, 0, 2, CO, CHp, 0, 2, &this_all_rates->rate_169, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HCOp, H2O, 0, 2, CO, H3Op, 0, 2, &this_all_rates->rate_170, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, HII, 0, 2, CHp, HI, 0, 2, &this_all_rates->rate_171, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, HII, 0, 2, CH2p, HI, 0, 2, &this_all_rates->rate_172, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, HeII, 0, 2, CII, HeI, H2, 3, &this_all_rates->rate_173, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, C2, HeII, 0, 2, CII, CI, HeI, 3, &this_all_rates->rate_174, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HII, 0, 2, OHp, HI, 0, 2, &this_all_rates->rate_175, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HeII, 0, 2, OII, HeI, HI, 3, &this_all_rates->rate_176, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, HII, 0, 2, H2Op, HI, 0, 2, &this_all_rates->rate_177, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, HeII, 0, 2, OH, HeI, HII, 3, &this_all_rates->rate_178, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, HeII, 0, 2, OHp, HeI, HI, 3, &this_all_rates->rate_179, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, HeII, 0, 2, H2Op, HeI, 0, 2, &this_all_rates->rate_180, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, HII, 0, 2, O2p, HI, 0, 2, &this_all_rates->rate_181, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, HeII, 0, 2, O2p, HeI, 0, 2, &this_all_rates->rate_182, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, HeII, 0, 2, OII, OI, HeI, 3, &this_all_rates->rate_183, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2p, CI, 0, 2, O2, CII, 0, 2, &this_all_rates->rate_184, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, COp, HI, 0, 2, CO, HII, 0, 2, &this_all_rates->rate_185, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Cm, HII, 0, 2, CI, HI, 0, 2, &this_all_rates->rate_186, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Om, HII, 0, 2, OI, HI, 0, 2, &this_all_rates->rate_187, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HeII, Hm, 0, 2, HeI, HI, 0, 2, &this_all_rates->rate_188, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, elec, 0, 2, CI, HI, 0, 2, &this_all_rates->rate_189, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, elec, 0, 2, CH, HI, 0, 2, &this_all_rates->rate_190, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, elec, 0, 2, CI, HI, HI, 3, &this_all_rates->rate_191, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, elec, 0, 2, CI, H2, 0, 2, &this_all_rates->rate_192, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, elec, 0, 2, CH2, HI, 0, 2, &this_all_rates->rate_193, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, elec, 0, 2, CH, H2, 0, 2, &this_all_rates->rate_194, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, elec, 0, 2, CH, HI, HI, 3, &this_all_rates->rate_195, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OHp, elec, 0, 2, OI, HI, 0, 2, &this_all_rates->rate_196, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, elec, 0, 2, OI, HI, HI, 3, &this_all_rates->rate_197, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, elec, 0, 2, OI, H2, 0, 2, &this_all_rates->rate_198, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, elec, 0, 2, OH, HI, 0, 2, &this_all_rates->rate_199, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, elec, 0, 2, HI, H2O, 0, 2, &this_all_rates->rate_200, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, elec, 0, 2, OH, H2, 0, 2, &this_all_rates->rate_201, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, elec, 0, 2, OH, HI, HI, 3, &this_all_rates->rate_202, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, elec, 0, 2, OI, HI, H2, 3, &this_all_rates->rate_203, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2p, elec, 0, 2, OI, OI, 0, 2, &this_all_rates->rate_204, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, COp, elec, 0, 2, CI, OI, 0, 2, &this_all_rates->rate_205, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HCOp, elec, 0, 2, OH, CI, 0, 2, &this_all_rates->rate_206, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HOCp, elec, 0, 2, CO, HI, 0, 2, &this_all_rates->rate_207, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, CI, 0, 2, CH, elec, 0, 2, &this_all_rates->rate_208, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, OI, 0, 2, OH, elec, 0, 2, &this_all_rates->rate_209, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Hm, OH, 0, 2, H2O, elec, 0, 2, &this_all_rates->rate_210, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Cm, HI, 0, 2, CH, elec, 0, 2, &this_all_rates->rate_211, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Cm, H2, 0, 2, CH2, elec, 0, 2, &this_all_rates->rate_212, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Cm, OI, 0, 2, CO, elec, 0, 2, &this_all_rates->rate_213, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Om, HI, 0, 2, OH, elec, 0, 2, &this_all_rates->rate_214, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Om, H2, 0, 2, H2O, elec, 0, 2, &this_all_rates->rate_215, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Om, CI, 0, 2, CO, elec, 0, 2, &this_all_rates->rate_216, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, elec, 0, 2, Cm, 0, 0, 1, &this_all_rates->rate_217, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, HI, 0, 2, CH, 0, 0, 1, &this_all_rates->rate_218, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, H2, 0, 2, CH2, 0, 0, 1, &this_all_rates->rate_219, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, CI, 0, 2, C2, 0, 0, 1, &this_all_rates->rate_220, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, HI, 0, 2, CHp, 0, 0, 1, &this_all_rates->rate_221, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, H2, 0, 2, CH2p, 0, 0, 1, &this_all_rates->rate_222, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, OI, 0, 2, COp, 0, 0, 1, &this_all_rates->rate_223, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, elec, 0, 2, Om, 0, 0, 1, &this_all_rates->rate_224, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, HI, 0, 2, OH, 0, 0, 1, &this_all_rates->rate_225, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, OI, 0, 2, O2, 0, 0, 1, &this_all_rates->rate_226, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HI, 0, 2, H2O, 0, 0, 1, &this_all_rates->rate_227, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, HI, HI, 3, H2, HI, 0, 2, &this_all_rates->rate_228, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, HI, H2, 3, H2, H2, 0, 2, &this_all_rates->rate_229, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, HI, HI, HeI, 3, H2, HeI, 0, 2, &this_all_rates->rate_230, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, CI, HeI, 3, C2, HeI, 0, 2, &this_all_rates->rate_231, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, OI, HeI, 3, CO, HeI, 0, 2, &this_all_rates->rate_232, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, OI, HeI, 3, COp, HeI, 0, 2, &this_all_rates->rate_233, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CI, OII, HeI, 3, COp, HeI, 0, 2, &this_all_rates->rate_234, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, HI, HeI, 3, OH, HeI, 0, 2, &this_all_rates->rate_235, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, HI, HeI, 3, H2O, HeI, 0, 2, &this_all_rates->rate_236, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, OI, HeI, 3, O2, HeI, 0, 2, &this_all_rates->rate_237, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OI, CH, 0, 2, HCOp, elec, 0, 2, &this_all_rates->rate_238, incl_mol, myGlobalVars->speciesIndices); 
  last_reaction = add_new_reaction(last_reaction, H3p, 0, 0, 1, H2, HII, 0, 2, &this_all_rates->rate_239, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3p, 0, 0, 1, H2p, HI, 0, 2, &this_all_rates->rate_240, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Cm, 0, 0, 1, CI, elec, 0, 2, &this_all_rates->rate_241, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, 0, 0, 1, CI, HI, 0, 2, &this_all_rates->rate_242, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, 0, 0, 1, CHp, elec, 0, 2, &this_all_rates->rate_243, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, 0, 0, 1, CI, HII, 0, 2, &this_all_rates->rate_244, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, 0, 0, 1, CH, HI, 0, 2, &this_all_rates->rate_245, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, 0, 0, 1, CH2p, elec, 0, 2, &this_all_rates->rate_246, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2p, 0, 0, 1, CHp, HI, 0, 2, &this_all_rates->rate_247, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, 0, 0, 1, CH2p, HI, 0, 2, &this_all_rates->rate_248, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH3p, 0, 0, 1, CHp, H2, 0, 2, &this_all_rates->rate_249, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, C2, 0, 0, 1, CI, CI, 0, 2, &this_all_rates->rate_250, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, Om, 0, 0, 1, OI, elec, 0, 2, &this_all_rates->rate_251, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, 0, 0, 1, OI, HI, 0, 2, &this_all_rates->rate_252, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, 0, 0, 1, OHp, elec, 0, 2, &this_all_rates->rate_253, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OHp, 0, 0, 1, OI, HII, 0, 2, &this_all_rates->rate_254, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, 0, 0, 1, OH, HI, 0, 2, &this_all_rates->rate_255, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, 0, 0, 1, H2Op, elec, 0, 2, &this_all_rates->rate_256, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, 0, 0, 1, H2p, OI, 0, 2, &this_all_rates->rate_257, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, 0, 0, 1, HII, OH, 0, 2, &this_all_rates->rate_258, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, 0, 0, 1, OII, H2, 0, 2, &this_all_rates->rate_259, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2Op, 0, 0, 1, OHp, HI, 0, 2, &this_all_rates->rate_260, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, 0, 0, 1, HII, H2O, 0, 2, &this_all_rates->rate_261, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, 0, 0, 1, H2p, OH, 0, 2, &this_all_rates->rate_262, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, 0, 0, 1, H2Op, HI, 0, 2, &this_all_rates->rate_263, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H3Op, 0, 0, 1, OHp, H2, 0, 2, &this_all_rates->rate_264, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, 0, 0, 1, O2p, elec, 0, 2, &this_all_rates->rate_265, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, 0, 0, 1, OI, OI, 0, 2, &this_all_rates->rate_266, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, 0, 0, 1, CI, OI, 0, 2, &this_all_rates->rate_267, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, HII, HI, elec, 3, &this_all_rates->rate_268, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, HII, Hm, 0, 2, &this_all_rates->rate_269, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, 0, 0, 1, COp, elec, 0, 2, &this_all_rates->rate_270, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH, 0, 0, 1, CI, HI, 0, 2, &this_all_rates->rate_272, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CHp, 0, 0, 1, CII, HI, 0, 2, &this_all_rates->rate_273, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, 0, 0, 1, CH2p, elec, 0, 2, &this_all_rates->rate_274, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CH2, 0, 0, 1, CH, HI, 0, 2, &this_all_rates->rate_275, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, C2, 0, 0, 1, CI, CI, 0, 2, &this_all_rates->rate_276, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, OH, 0, 0, 1, OI, HI, 0, 2, &this_all_rates->rate_277, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, H2O, 0, 0, 1, OH, HI, 0, 2, &this_all_rates->rate_278, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, 0, 0, 1, OI, OI, 0, 2, &this_all_rates->rate_279, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, O2, 0, 0, 1, O2p, elec, 0, 2, &this_all_rates->rate_280, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CO, 0, 0, 1, CI, OI, 0, 2, &this_all_rates->rate_281, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, OH, 0, 2, CO, HII, 0, 2, &this_all_rates->rate_283, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, MgII, elec, 0, 2, MgI, 0, 0, 1, &this_all_rates->rate_290, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, SII, elec, 0, 2, SI, 0, 0, 1, &this_all_rates->rate_291, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CaII, elec, 0, 2, CaI, 0, 0, 1, &this_all_rates->rate_292, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CaIII, elec, 0, 2, CaII, 0, 0, 1, &this_all_rates->rate_293, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, CII, MgI, 0, 2, CI, MgII, 0, 2, &this_all_rates->rate_294, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, NII, MgI, 0, 2, NI, MgII, 0, 2, &this_all_rates->rate_295, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, SiII, MgI, 0, 2, SiI, MgII, 0, 2, &this_all_rates->rate_296, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, SII, MgI, 0, 2, SI, MgII, 0, 2, &this_all_rates->rate_297, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, COp, H2, 0, 2, HCOp, HI, 0, 2, &this_all_rates->rate_303, incl_mol, myGlobalVars->speciesIndices);
  last_reaction = add_new_reaction(last_reaction, COp, H2, 0, 2, HOCp, HI, 0, 2, &this_all_rates->rate_304, incl_mol, myGlobalVars->speciesIndices);
  ...
  for (i = 0; i < chimesRateTables.NonEqIon->N_Elements; i++)
	...
	{
	  last_reaction = add_new_reaction(last_reaction, HI, 0, 0, 1, HII, elec, 0, 2, &(this_all_rates->BensRates[i].cosmicRays[0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HI, 0, 0, 1, HII, elec, 0, 2, &(this_all_rates->BensRates[i].PhotoIon[0][0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, Hm, 0, 0, 1, HI, elec, 0, 2, &(this_all_rates->BensRates[i].PhotoIon[1][0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, H2, 0, 0, 1, H2p, elec, 0, 2, &(this_all_rates->BensRates[i].PhotoIon[2][0]), incl_mol, myGlobalVars->speciesIndices);
	}
      else if (chimesRateTables.NonEqIon->IonIndexBegin[i] == HeI)
	{
	  last_reaction = add_new_reaction(last_reaction, HeII, elec, 0, 2, HeIII, elec, elec, 3, &(this_all_rates->BensRates[i].CollisIon[1]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HeI, 0, 0, 1, HeII, elec, 0, 2, &(this_all_rates->BensRates[i].PhotoIon[0][0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HeII, 0, 0, 1, HeIII, elec, 0, 2, &(this_all_rates->BensRates[i].PhotoIon[1][0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HeIII, elec, 0, 2, HeII, 0, 0, 1, &(this_all_rates->BensRates[i].Recomb[1]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HeI, 0, 0, 1, HeII, elec, 0, 2, &(this_all_rates->BensRates[i].cosmicRays[0]), incl_mol, myGlobalVars->speciesIndices);
	  last_reaction = add_new_reaction(last_reaction, HeII, 0, 0, 1, HeIII, elec, 0, 2, &(this_all_rates->BensRates[i].cosmicRays[1]), incl_mol, myGlobalVars->speciesIndices);
	  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHrec_mask[2] == 1)
	    last_reaction = add_new_reaction(last_reaction, HeIII, HI, 0, 2, HeII, HII, 0, 2, &(this_all_rates->BensRates[i].CTHrec[1]), incl_mol, myGlobalVars->speciesIndices);
	  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHion_mask[1] == 1)
	    last_reaction = add_new_reaction(last_reaction, HeII, HII, 0, 2, HeIII, HI, 0, 2, &(this_all_rates->BensRates[i].CTHion[1]), incl_mol, myGlobalVars->speciesIndices);
	}
      else
	{
	  for (j = 0; j < chimesRateTables.NonEqIon->N_Ions[i] - 1; j++)
	    {
	      last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), elec, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), elec, elec, 3, &(this_all_rates->BensRates[i].CollisIon[j]), incl_mol, myGlobalVars->speciesIndices); 
	      last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), elec, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), 0, 0, 1, &(this_all_rates->BensRates[i].Recomb[j]), incl_mol, myGlobalVars->speciesIndices); 
	      last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), 0, 0, 1, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), elec, 0, 2, &(this_all_rates->BensRates[i].cosmicRays[j]), incl_mol, myGlobalVars->speciesIndices);

	      /* Note that we only include CT for ions j <= 4*/
	      if (j <= 4)
		{
		  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHion_mask[j] == 1)
		    last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), HII, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), HI, 0, 2, &(this_all_rates->BensRates[i].CTHion[j]), incl_mol, myGlobalVars->speciesIndices); 
		  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHeion_mask[j] == 1)
		    last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), HeII, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), HeI, 0, 2, &(this_all_rates->BensRates[i].CTHeion[j]), incl_mol, myGlobalVars->speciesIndices); 
		  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHrec_mask[j + 1] == 1)
		    last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), HI, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), HII, 0, 2, &(this_all_rates->BensRates[i].CTHrec[j]), incl_mol, myGlobalVars->speciesIndices); 
		  if (chimesRateTables.NonEqIon->NonEqRates[i].CTHerec_mask[j + 1] == 1)
		    last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + 1), HeI, 0, 2, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), HeII, 0, 2, &(this_all_rates->BensRates[i].CTHerec[j]), incl_mol, myGlobalVars->speciesIndices);
		}
	      ...
	      for (k = 0; k < chimesRateTables.NonEqIon->N_Auger[i]; k++)
		{
		  if (chimesRateTables.NonEqIon->NonEqRates[i].sigmaphot[0][j][k] > 0.0)
		    last_reaction = add_new_reaction(last_reaction, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j), 0, 0, 1, (chimesRateTables.NonEqIon->IonIndexBegin[i] + j + k + 1), elec, -k, 2, &(this_all_rates->BensRates[i].PhotoIon[j][k]), incl_mol, myGlobalVars->speciesIndices); 
		}
	    }
	}	
    }
...
{
  myGasVars->abundances = (double *) malloc(myGlobalVars->totalNumberOfSpecies * sizeof(double));
...
void initialise_gas_abundances(struct gasVariables *myGasVars, struct globalVariables *myGlobalVars)
{
  ...
  if (myGlobalVars->InitIonState >= 0 && myGlobalVars->InitIonState <= 26)
    ...
    {
      printf("initialise_gas_abundances() mode not recognised. Assuming fully neutral");
      init_ion_state = 0;
    }
