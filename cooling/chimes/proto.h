...
double determine_subcyclestep(struct gasVariables *myGasVars, struct globalVariables *myGlobalVars, int *abundant_indices, struct Species_Structure *species, struct Reactions_Structure *reactions_root, struct All_rate_variables_structure *this_all_rates);
int is_x_in_array(int x, int *my_array, int len_array);
void update_species_fluxes(double *abundances, double temperature, struct Reactions_Structure *reactions_root, struct Species_Structure *species, double Tmol, int mode, int *speciesIndices, struct globalVariables *myGlobalVars);
double evaluate_reduced_network_size(struct Species_Structure *species, struct gasVariables *myGasVars, struct globalVariables *myGlobalVars, struct Reactions_Structure *reaction_list_node, int *myNetworkSize, struct All_rate_variables_structure *this_all_rates, struct Reactions_Structure *this_all_reactions_root, struct Reactions_Structure *this_nonmolecular_reactions_root);
