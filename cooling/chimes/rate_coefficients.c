...
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction1, T_index, dT));
}

double k2(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction2, T_index, dT));
}

double k3(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction3, T_index, dT));
}

double k5(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction5, T_index, dT));
}

double k6(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction6, T_index, dT));
}

double k7(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction7, T_index, dT));
}

double k10(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction10, T_index, dT));
}

double k11(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction11, T_index, dT));
}
...
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction15, T_index, dT));
}

double k16(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction16, T_index, dT));
}

double k17(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction17, T_index, dT));
}

double k24(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction24, T_index, dT));
}
...
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction25di, T_index, dT));
}

double k26(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction26, T_index, dT));
}

double k27(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction27, T_index, dT));
}

double k83(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction83, T_index, dT));
}

double k87(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction87, T_index, dT));
}

double k97(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction97, T_index, dT));
}

double k101(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction101, T_index, dT));
}

double k106(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction106, T_index, dT));
}

double k107(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction107, T_index, dT));
}

double k112(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction112, T_index, dT));
}

double k113(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction113, T_index, dT));
}

double k114(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction114, T_index, dT));
}

double k116(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction116, T_index, dT));
}

double k117(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction117, T_index, dT));
}

double k120(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction120, T_index, dT));
}

double k121(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction121, T_index, dT));
}

double k122(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction122, T_index, dT));
}

double k124(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction124, T_index, dT));
}

double k128(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction128, T_index, dT));
}

double k129(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction129, T_index, dT));
}

double k130(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction130, T_index, dT));
}

double k131(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction131, T_index, dT));
}

double k133(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction133, T_index, dT));
}

double k134(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction134, T_index, dT));
}

double k135(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction135, T_index, dT));
}

double k136(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction136, T_index, dT));
}

double k137(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction137, T_index, dT));
}

double k138(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction138, T_index, dT));
}

double k139(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction139, T_index, dT));
}

double k142(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction142, T_index, dT));
}

double k147(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction147, T_index, dT));
}

double k150(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction150, T_index, dT));
}

double k186(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction186, T_index, dT));
}

double k187(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction187, T_index, dT));
}

double k188(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction188, T_index, dT));
}

double k189(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction189, T_index, dT));
}

double k190(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction190, T_index, dT));
}

double k191(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction191, T_index, dT));
}

double k192(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction192, T_index, dT));
}

double k193(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction193, T_index, dT));
}

double k194(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction194, T_index, dT));
}

double k195(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction195, T_index, dT));
}

double k196(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction196, T_index, dT));
}

double k197(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction197, T_index, dT));
}

double k198(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction198, T_index, dT));
}

double k199(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction199, T_index, dT));
}

double k200(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction200, T_index, dT));
}

double k201(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction201, T_index, dT));
}

double k202(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction202, T_index, dT));
}

double k203(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction203, T_index, dT));
}

double k204(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction204, T_index, dT));
}

double k205(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction205, T_index, dT));
}

double k206(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction206, T_index, dT));
}

double k207(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction207, T_index, dT));
}

double k220(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction220, T_index, dT));
}

double k221(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction221, T_index, dT));
}

double k222(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction222, T_index, dT));
}

double k223(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction223, T_index, dT));
}

double k225(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction225, T_index, dT));
}

double k226(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction226, T_index, dT));
}

double k227(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction227, T_index, dT));
}

double k228(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction228, T_index, dT));
}

double k229(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction229, T_index, dT));
}

double k230(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction230, T_index, dT));
}

double k231(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction231, T_index, dT));
}

double k232(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction232, T_index, dT));
}

double k233(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction233, T_index, dT));
}

double k234(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction234, T_index, dT));
}

double k235(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction235, T_index, dT));
}

double k236(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction236, T_index, dT));
}

double k237(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction237, T_index, dT));
}

double k238(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction238, T_index, dT));
}

double k283(int T_index, double dT)
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction283, T_index, dT));
}
...
double grain_recomb_jac(double T, double xe, double nH_tot, double dust_G, double extinction, double dust_ratio, double a, double b, double c, double d, double e)
{
  ...
  if (dust_G == 0.0 || xe == 0.0)
	...
	{
	  dpsi_dxe = -psi / xe;
	  dk_dpsi = -a * dust_ratio * (b * c * pow(psi, c - 1.0) * (1.0 + d * pow(psi, e)) + b * d * e * pow(psi, c + e - 1.0)) / pow(1.0 + b * pow(psi, c) * (1.0 + d * pow(psi, e)), 2.0);
...
double k61(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      ...
      if (psi > 1.0e-90)
	return 1.225e-13 * dust_ratio / (1.0 + 8.074e-6 * pow(psi, 1.378) * (1.0 + 5.087e2 * pow(T, 0.01586) * pow(psi, (-0.4723 - 1.102e-5 * log(T)))));
      else
	return 1.225e-13 * dust_ratio;
    }
}  
...
double k63(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      ...
      if (psi > 1.0e-90)
	return 5.572e-14 * dust_ratio / (1.0 + 3.185e-7 * pow(psi, 1.512) * (1.0 + 5.115e3 * pow(T, 3.903e-7) * pow(psi, (-0.4956 - 5.494e-7 * log(T)))));
      else
	return 5.572e-14 * dust_ratio;
    }
}
...
double k64(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 4.558e-13 * dust_ratio / (1.0 + 6.089e-3 * pow(psi, 1.128) * (1.0 + 4.331e2 * pow(T, 0.04845) * pow(psi, (-0.812 - 1.333e-4 * log(T)))));
      else
	return 4.558e-13 * dust_ratio;
    }
}  
...
double k65(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 3.063e-14 * dust_ratio / (1.0 + 8.074e-6 * pow(psi, 1.378) * (1.0 + 5.087e2 * pow(T, 0.01586) * pow(psi, (-0.4723 - 1.102e-5 * log(T)))));
      else
	return 3.063e-14 * dust_ratio;
    }
}  
...
double k66(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 2.166e-14 * dust_ratio / (1.0 + 5.678e-8 * pow(psi, 1.874) * (1.0 + 4.375e4 * pow(T, 1.635e-6) * pow(psi, (-0.8964 - 7.538e-5 * log(T)))));
      else
	return 2.166e-14 * dust_ratio;
    }
}  
...
double k77(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 1.701e-14 * dust_ratio / (1.0 + 9.554e-8 * pow(psi, 1.851) * (1.0 + 5.763e4 * pow(T, 4.116e-8) * pow(psi, (-0.9456 - 2.198e-5 * log(T)))));
      else
	return 1.701e-14 * dust_ratio;
    }
}
...
{
  return 5.7e-10 * Go * exp(-2.37 * extinction) / 1.7;
}

double R53(double NH2, double temperature, double *photon_density, double extinction, double b_5, struct globalVariables *myGlobalVars, struct gasVariables *myGasVars)
{
...
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction84, T_index, dT));
}


double k85(double T)
{
  return 3.7e-14 * exp(-35.0 / T);
}
...
{
  return pow(10.0, interpol_1d_mydbl(chimesRateTables.RatesTables->reaction157, T_index, dT));
}
...
{
  return 4.9e-13 * Go * exp(-1.8  * extinction) / 1.7;
}

double R240(double Go, double extinction)
{
  return 4.9e-13 * Go * exp(-2.3 * extinction) / 1.7;
}

double R241(double Go, double extinction)
{
  return 2.4e-7 * Go * exp(-0.9 * extinction) / 1.7;
}

double R242(double Go, double extinction)
{
  return 9.2e-10 * Go * exp(-1.72  * extinction) / 1.7;
}

double R243(double Go, double extinction)
{
  return 7.7e-10 * Go * exp(-3.2 * extinction) / 1.7;
}

double R244(double Go, double extinction)
{
  return 3.3e-10 * Go * exp(-2.94 * extinction) / 1.7;
}

double R245(double Go, double extinction)
{
  return 5.8e-10 * Go * exp(-2.21 * extinction) / 1.7;
}

double R246(double Go, double extinction)
{
  return 5.9e-10 * Go * exp(-2.3 * extinction) / 1.7;
}

double R247(double Go, double extinction)
{
  return 1.4e-10 * Go * exp(-1.7 * extinction) / 1.7;
}

double R248(double Go, double extinction)
{
  return 1.0e-9 * Go * exp(-1.7 * extinction) / 1.7;
}
...
{
  return 2.4e-10 * Go * exp(-2.57 * extinction) / 1.7;
}

double R251(double Go, double extinction)
{
  return 2.4e-7 * Go * exp(-0.5 * extinction) / 1.7;
}

double R252(double Go, double extinction)
{
  return 3.7e-10 * Go * exp(-2.24 * extinction) / 1.7;
}

double R253(double Go, double extinction)
{
  return 1.6e-12 * Go * exp(-3.1 * extinction) / 1.7;
}

double R254(double Go, double extinction)
{
  return 1.1e-11 * Go * exp(-3.5 * extinction) / 1.7;
}

double R255(double Go, double extinction)
{
  return 6.0e-10 * Go * exp(-2.2 * extinction) / 1.7;
}

double R256(double Go, double extinction)
{
  return 3.2e-11 * Go * exp(-3.9 * extinction) / 1.7;
}
...
{
  return 7.6e-10 * Go * exp(-3.87 * extinction) / 1.7;
}

double R266(double Go, double extinction)
{
  return 7.9e-10 * Go * exp(-2.13 * extinction) / 1.7;
}
...
double R267(double Go, double NH2, double NCO, double extinction, struct globalVariables *myGlobalVars)
{
  ...
  if (NCO < pow(10.0, chimesRateTables.NonEqIon->COself_shielding_N[0]))
    ...
    {
      get_index_1d_irregular(chimesRateTables.NonEqIon->COself_shielding_N, chimesRateTables.NonEqIon->shielding_dimensions[0], log10(NCO), &NCO_index, &dN_CO);
    }
  else
    {
  ...
  if (NH2 < pow(10.0, chimesRateTables.NonEqIon->H2CO_shielding_N[0]))
    ...
    {
      get_index_1d_irregular(chimesRateTables.NonEqIon->H2CO_shielding_N, chimesRateTables.NonEqIon->shielding_dimensions[1], log10(NH2), &NH2_index, &dN_H2);
    }
  else
    {
...
double k290(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 2.51e-14 * dust_ratio / (1.0 + 8.116e-8 * pow(psi, 1.864) * (1.0 + 6.17e4 * pow(T, 2.169e-6) * pow(psi, (-0.9605 - 7.232e-5 * log(T)))));
      else
	return 2.51e-14 * dust_ratio;
    }
}
...
double k291(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 3.064e-14 * dust_ratio / (1.0 + 7.769e-8 * pow(psi, 1.319) * (1.0 + 1.087e2 * pow(T, 3.475e-1) * pow(psi, (-0.479 - 4.689e-2 * log(T)))));
      else
	return 3.064e-14 * dust_ratio;
    }
}
...
double k292(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 1.636e-14 * dust_ratio / (1.0 + 8.208e-9 * pow(psi, 2.289) * (1.0 + 1.254e5 * pow(T, 1.349e-9) * pow(psi, (-1.1506 - 7.204e-4 * log(T)))));
      else
	return 1.636e-14 * dust_ratio;
    }
}
...
double k293(double T, double ne, double dust_G, double extinction, double dust_ratio)
{
  if (dust_G == 0.0 || ne == 0.0)
  ...
  else
    {
      double psi = dust_G * exp(-extinction * G0_GAMMA) * pow(T, 0.5) / ne;
      if (psi > 1.0e-90)
	return 8.27e-14 * dust_ratio / (1.0 + 2.051e-4 * pow(psi, 1.252) * (1.0 + 1.59e2 * pow(T, 6.072e-2) * pow(psi, (-0.598 - 4.497e-7 * log(T)))));
      else
	return 8.27e-14 * dust_ratio;
    }
}
...
double cr_secondary_ionisation(double xHII, int ion_index)
{
  ...
  if (xHII <= pow(10.0, chimesRateTables.NonEqIon->x_ion_fraction[0]))
    ...
    {
      get_index_1d_irregular(chimesRateTables.NonEqIon->x_ion_fraction, chimesRateTables.NonEqIon->secondary_ionisation_dims[0], log10(xHII), &x_ion_index, &dx);
      if (ion_index == HI)
