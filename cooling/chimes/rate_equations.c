...
void check_constraint_equations(struct gasVariables *myGasVars, struct globalVariables *myGlobalVars)
{
  ...
  if (fabs((x - myGasVars->abundances[myGlobalVars->speciesIndices[elec]]) / myGasVars->abundances[myGlobalVars->speciesIndices[elec]]) > 0.01)
...
void set_constraint_equations(void *user_data, double *output_array)
{
  ...
  if (data->myGlobalVars->element_included[0] == 1 && data->myGasVars->element_abundances[1] > 0.0)
	...
	x_temp += i * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CI + i]];
      ...
      x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH3p]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CHp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH2p]];
    }
  ...
  if (data->myGlobalVars->element_included[2] == 1 && data->myGasVars->element_abundances[3] > 0.0)
	...
	x_temp += i * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OI + i]];
      ...
      x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OHp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2Op]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H3Op]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[O2p]];
    }

  if (data->myGlobalVars->element_included[0] == 1 && data->myGasVars->element_abundances[1] > 0.0 && data->myGlobalVars->element_included[2] == 1 && data->myGasVars->element_abundances[3] > 0.0)
    x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HCOp]] +  + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[COp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HOCp]];
  ...
  x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2p]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H3p]];

  output_array[output_index] = x_temp;
  output_index += 1;
  
  /* Hydrogen */
  x_temp = data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HI]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[Hm]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2p]] + 3.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H3p]];

  if (data->myGlobalVars->element_included[0] == 1)
    x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH2]] + 3.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH3p]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CHp]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH2p]];
  if (data->myGlobalVars->element_included[2] == 1)
    x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OH]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2O]]+ data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OHp]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2Op]] + 3.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H3Op]];
  if (data->myGlobalVars->element_included[0] == 1 && data->myGlobalVars->element_included[2] == 1)
    x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HCOp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HOCp]];
  ...
  if (data->myGasVars->element_abundances[0] > 0.0)
    {
      output_array[output_index] = data->myGasVars->element_abundances[0] - (data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HeI]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HeIII]]);
      output_index += 1;
    }
  ...
  if (data->myGasVars->element_abundances[1] > 0.0 && data->myGlobalVars->element_included[0] == 1)
	...
	x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CII + i]];
      ...
      x_temp += 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[C2]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH2]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH3p]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CHp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CH2p]];
      if (data->myGlobalVars->element_included[2] == 1)
	x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HCOp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CO]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[COp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HOCp]];
  ...
  if (data->myGasVars->element_abundances[3] > 0.0 && data->myGlobalVars->element_included[2] == 1)
	...
	x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OII + i]];
      ...
      x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OH]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2O]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[O2]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[OHp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[H2Op]] + 2.0 * data->myGasVars->abundances[data->myGlobalVars->speciesIndices[O2p]];
      if (data->myGlobalVars->element_included[0] == 1)
	x_temp += data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HCOp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[CO]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[COp]] + data->myGasVars->abundances[data->myGlobalVars->speciesIndices[HOCp]];
...
int kin_f(N_Vector y, N_Vector ydot, void *user_data)
{
  ...
  indices = (int *) malloc(data->network_size * sizeof(int));
  enum_indices = (int *) malloc(data->myGlobalVars->totalNumberOfSpecies * sizeof(int));
  ...
  update_rates(data->myGasVars, data->myGlobalVars, *(data->HI_column), *(data->H2_column), *(data->HeI_column), *(data->HeII_column), *(data->CO_column), *(data->extinction), data->this_all_rates); 
  ...
  while (current_reaction->next_reaction != NULL)
      ...
      if (current_reaction->flag_included == 1)
	{
	  ...
	  if (current_reaction->extra_Auger_electrons > 0)
	    data->species[data->myGlobalVars->speciesIndices[elec]].creation_rate += current_rate * current_reaction->extra_Auger_electrons;
	}
    }
  ...
  constr_index = 0;
  NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[elec]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[elec]]) - constraint_abundances[constr_index++];
  NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[HII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[HII]]) - constraint_abundances[constr_index++];
  NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[HeII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[HeII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[1] > 0.0 && data->myGlobalVars->element_included[0] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[CII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[CII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[2] > 0.0 && data->myGlobalVars->element_included[1] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[NII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[NII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[3] > 0.0 && data->myGlobalVars->element_included[2] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[OII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[OII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[4] > 0.0 && data->myGlobalVars->element_included[3] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[NeII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[NeII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[5] > 0.0 && data->myGlobalVars->element_included[4] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[MgII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[MgII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[6] > 0.0 && data->myGlobalVars->element_included[5] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[SiII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[SiII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[7] > 0.0 && data->myGlobalVars->element_included[6] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[SII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[SII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[8] > 0.0 && data->myGlobalVars->element_included[7] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[CaII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[CaII]]) - constraint_abundances[constr_index++];
  if (data->myGasVars->element_abundances[9] > 0.0 && data->myGlobalVars->element_included[8] == 1)
    NV_Ith_S(ydot, enum_indices[data->myGlobalVars->speciesIndices[FeII]]) = NV_Ith_S(y, enum_indices[data->myGlobalVars->speciesIndices[FeII]]) - constraint_abundances[constr_index++];
...
int f(realtype t, N_Vector y, N_Vector ydot, void *user_data)
{
  ...
  if (data->myGlobalVars->ThermEvolOn == 1)
	...
	NV_Ith_S(ydot, data->network_size) = max(-calculate_total_cooling_rate(data->myGasVars, data->myGlobalVars, *(data->HI_column), *(data->HeI_column), *(data->HeII_column), *(data->H2_column), *(data->CO_column), *(data->H2O_column), *(data->OH_column), *(data->extinction), data->this_all_rates), 0.0);  /* Once T falls below T_floor, set T_dot >= 0 */
    }
