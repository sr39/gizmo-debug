    ...
    if(P[i].Type == 0)
      {
          ...
          double a_limiter = DMIN(0.5, 0.125 * SphP[i].ConditionNumber); //
          a_limiter = 0.5;
          a_limiter = 0.25; if(SphP[i].ConditionNumber>100) a_limiter=DMIN(0.5, 0.25 + 0.25 * (SphP[i].ConditionNumber-100)/100);
