...
//#endif
            ...
            if(SphP[i].Density > 0)
            {
                ...
                CR_kappa_streaming = GAMMA_COSMICRAY * v_streaming * CRPressureGradScaleLength; /* all physical units */
#ifndef COSMIC_RAYS_M1
                CR_kappa_streaming /= GAMMA_COSMICRAY_MINUS1; // ensure correct units for subsequent operations //
#endif
#endif
