...
#endif
            double beta2,B2; for(k=0;k<3;k++) {double b=P[i].Gas_B[k]*All.cf_a2inv, v=P[p].Vel[k]/(All.cf_atime*reduced_C); B2=b*b; beta2=v*v;;} /* get magnitude and unit vector for B, and vector beta [-true- beta here] */
